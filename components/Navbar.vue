    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16 items-center">
        ...
        <div class="hidden md:flex md:space-x-8">
          ...
          <a href="https://launches.kph.club" target="_blank" rel="noopener noreferrer" class="text-gray-700 hover:text-blue-600">
            Product Launches
          </a>
          <a href="https://blog.kph.club" target="_blank" rel="noopener noreferrer" class="text-gray-700 hover:text-blue-600">
            Blog
          </a>
          <a href="https://learn.kph.club" target="_blank" rel="noopener noreferrer" class="text-gray-700 hover:text-blue-600">
            Masterclass
          </a>
        </div>
      ...
      <div v-show="isOpen" class="md:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <a href="https://launches.kph.club" target="_blank" rel="noopener noreferrer" class="block px-3 py-2 text-gray-700 hover:text-blue-600">
            Launches
          </a>
          <a href="https://blog.kph.club" target="_blank" rel="noopener noreferrer" class="block px-3 py-2 text-gray-700 hover:text-blue-600">
            Blog
          </a>
          <a href="https://learn.kph.club" target="_blank" rel="noopener noreferrer" class="block px-3 py-2 text-gray-700 hover:text-blue-600">
            Masterclass
          </a>
        </div>
