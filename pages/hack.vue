<template>
    <div>
                    ...
                    <div class="mx-auto max-w-2xl text-center">
                        ...
                        <h1 class="text-5xl font-bold tracking-tight text-gray-900 sm:text-7xl animate-fade-in">
                            ...
                            <span class="relative inline-block align-middle sm:ml-2">
                                <span
                                    class="bg-emerald-100 text-emerald-600 px-3 py-1 rounded-lg inline-block font-extrabold shadow-sm animate-fade-in animation-delay-200 tilt-hero whitespace-nowrap">Build
                                </span>
                            </span>
                            <br class="sm:hidden">
                            <span class="relative inline-block align-middle sm:ml-2">
                                <span
                                    class="bg-emerald-100 text-emerald-600 px-3 py-1 rounded-lg inline-block font-extrabold shadow-sm animate-fade-in animation-delay-200 tilt-hero whitespace-nowrap">&
                                    Launch</span>
                            </span>
                        </h1>
                        ...
                        <!-- JOIN NOW CTA -->
                        <div class="mt-8">
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdvMpY7b3fyYfLEwgE20EqKSGD9vnm4fbYMOwCmlLVjyGUYTw/viewform?usp=publish-editor"
                                target="_blank"
                        ...
                        <p v-if="!isEventLive" class="mt-6 text-red-500 font-semibold text-center">Hurry up, spots are
                            limited!</p>
                    </div>
                </div>
            </section>
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div class="text-center max-w-2xl mx-auto mb-12">
                    ...
                    <p class="mt-4 text-lg leading-8 text-gray-600">
                        The mission: Make Kerala the best place to build and launch successful products. We help you go
                        from zero to launch with funding, mentorship, GTM, and your first users. Exciting prizes await!
                    </p>
                </div>
                <!-- Card Grid -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div class="group animate-slide-up" style="animation-delay:0ms">
                        <div class="block transform-gpu hover:-translate-y-1 transition-all duration-300">
                            <div
                                class="aspect-video overflow-hidden rounded-xl border group-hover:border-orange-200 transition-colors bg-gradient-to-br from-orange-50 to-emerald-50 flex items-center justify-center">
                            ...
                            <div class="mt-5 sm:mt-6 p-3 sm:p-4 border rounded-lg">
                                ...
                                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 group-hover:text-gray-700">
                                    Build & Launch</h3>
                                <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">Go from idea to product launch.
                                    Get hands-on support, mentorship, and resources.</p>
                            </div>
                        </div>
                    </div>
                    <div class="group animate-slide-up" style="animation-delay:100ms">
                        <div class="block transform-gpu hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div class="mt-5 sm:mt-6 p-3 sm:p-4 border rounded-lg">
                                ...
                                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 group-hover:text-gray-700">
                                    Funding & GTM</h3>
                                <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">Winners get funding, GTM help,
                                    and access to KPH's investor and mentor network.</p>
                            </div>
                        </div>
                    </div>
                    <div class="group animate-slide-up" style="animation-delay:200ms">
                        <div class="block transform-gpu hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div class="mt-5 sm:mt-6 p-3 sm:p-4 border rounded-lg">
                                ...
                                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 group-hover:text-gray-700">
                                    Exciting Prizes</h3>
                                <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">Win cash prizes, tools, and
                                    exclusive opportunities for your product/startup.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-10 bg-gray-50 border-t">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div class="text-center max-w-2xl mx-auto mb-12">
                    ...
                    <p class="mt-4 text-lg leading-8 text-gray-600">
                        Support Kerala's next wave of founders and product builders. Get your brand in front of the most
                        ambitious makers and innovators in the state. Sponsoring gives you unique access to talent,
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    <article
                        class="relative group bg-white rounded-xl border p-6 hover:shadow-sm transition-all duration-300 animate-slide-in"
                        style="animation-delay: 0ms">
                        <div class="flex items-start gap-3 sm:gap-4">
                            <div
                                class="flex-shrink-0 mt-1 transform-gpu group-hover:rotate-12 transition-transform duration-300">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">
                                    Connect with Kerala's brightest founders, makers, and early-stage startups. Be the
                                    first to discover and support emerging talent.
                                </p>
                            </div>
                        </div>
                        <div
                            class="absolute bottom-0 left-0 w-0 h-0.5 bg-emerald-500 group-hover:w-full transition-all duration-500">
                        </div>
                    </article>
                    <article
                        class="relative group bg-white rounded-xl border p-6 hover:shadow-sm transition-all duration-300 animate-slide-in"
                        ...
                        <div class="flex items-start gap-3 sm:gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">
                                    Help shape Kerala's product/startup ecosystem and support the next generation of
                                    builders. Your sponsorship creates real, lasting impact.
                                </p>
                            </div>
                        </div>
                        <div
                ...
                <div class="text-center mt-12">
                    ...
                    <p class="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-500">Partner with us to power Kerala's
        ...
        <button @click="sponsorCTA"
            class="fixed z-40 bottom-6 right-6 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg flex items-center gap-2 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-orange-200 text-sm">
            <Rocket class="h-5 w-5" />
